...
public class PedidosMain {
	...
	static void mostrarMenu() {
		...
		System.out.println("4.- Pedidos anteriores a");
	...
	static void pedidosAnteriores() {
		Scanner sc=new Scanner(System.in);
		System.out.println("Introduce nº meses: ");
		int meses=Integer.parseInt(sc.nextLine());
		ArrayList<Pedido> pedidos=pedidosService.pedidosPrecio(meses);
		for(Pedido p:pedidos) {
			System.out.println("Producto: "+p.getProducto());
			System.out.println("Fecha: "+p.getFechaPedido());
			System.out.println("Precio: "+p.getPrecio());
